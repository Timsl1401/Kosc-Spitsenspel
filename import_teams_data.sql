-- Import script voor KOSC teams en spelers data
-- Dit script maakt de benodigde tabellen aan en importeert de data
...
FROM (VALUES 
  ...
  ('Luuk Wilmink', 'Verdediger', 1000000),
  ('Thomas Brons', 'Verdediger', 1000000),
