...
-- Stap 1: Verwijder alleen de probleem policies (niet alles)
...
-- Stap 3: Zorg dat gebruikers hun eigen data kunnen beheren
...
-- Stap 4: Admin policies alleen voor schrijven (geen recursion meer)
...
-- Stap 5: Zorg dat admin_emails toegankelijk blijft
