...
class Team extends Component
{
    ...
    public function mount(){
        ...
        $this->teams = Teams::with(['players' => function($q){
            $q->orderBy('position');
        }])->get();
        $this->players = Auth::user()->players->sortBy('position');
    ...
    public function checkTransferPeriod(){
        $this->canTransfer = \AppHelper::instance()->canTransfer();
        $this->transferPeriod = \AppHelper::instance()->isTransferPeriod();
    }
